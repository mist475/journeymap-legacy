...
minecraft {
  ...
  groupsToExcludeFromAutoReobfMapping.addAll("com.diffplug", "com.diffplug.durian")
}

// Put the version from gradle into mcmod.info
tasks.processResources.configure {
  inputs.property("version", project.version)
  inputs.property("jmedition","Unlimited") //TODO: separate this to fairplay and unlimited again
  inputs.property("mcversion", minecraft.mcVersion)
  inputs.property("forgeversion", "10.13.4.1614") //TODO: set to previous minimum required version

  filesMatching("mcmod.info") {
    expand(mapOf(
            "version" to project.version,
            "jmedition" to "Unlimited",
            "mcversion" to minecraft.mcVersion,
            "forgeversion" to "10.13.4.1614"
    ))
  }
}
